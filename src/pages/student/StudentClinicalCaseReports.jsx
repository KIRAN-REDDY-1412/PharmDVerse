...
const MOCK_REPORTS = [
  { id: 'CR-2001', type: 'Patient Profile Report', hospital: 'City General Hospital', department: 'General Medicine', status: 'Approved', date: '2026-05-12' },
  { id: 'CR-2002', type: 'Patient Counselling Report', hospital: 'City General Hospital', department: 'Cardiology', status: 'Submitted', date: '2026-06-18' },
  { id: 'CR-2003', type: 'Drug Information Request', hospital: 'Apollo Hospital', department: 'Neurology', status: 'Draft', date: '2026-07-22' },
  { id: 'CR-2004', type: 'Pharmacist Intervention', hospital: 'Apollo Hospital', department: 'General Medicine', status: 'Returned', date: '2026-08-01' },
  { id: 'CR-2005', type: 'Adverse Drug Reaction', hospital: 'City General Hospital', department: 'Cardiology', status: 'Approved', date: '2026-08-10' },
];
...
const StudentClinicalCaseReports = () => {
  ...
  const handleView = (row) => {
    setSelectedRecord([
      ...
      { label: 'Documentation Type', value: row.type },
            ...
            <div className="filter-group">
              ...
              <div className="select-wrapper">
                <select>
                  ...
                  <option>Patient Counselling</option>
...
export default StudentClinicalCaseReports;

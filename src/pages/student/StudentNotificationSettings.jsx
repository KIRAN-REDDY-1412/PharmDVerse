...
const StudentNotificationSettings = () => {
  const [settings, setSettings] = useState(() => {
    const saved = localStorage.getItem('erp_student_notification_settings');
  ...
  const handleSave = () => {
    localStorage.setItem('erp_student_notification_settings', JSON.stringify(settings));
  ...
  const handleReset = () => {
    ...
    localStorage.removeItem('erp_student_notification_settings');
  };
      ...
      <div className="settings-page-container">
        ...
        <div className="page-header">
          ...
          <div className="breadcrumbs">
            ...
            <Link to="/student/settings" className="breadcrumb-link">Settings</Link>
            <span className="breadcrumb-separator">&gt;</span>
